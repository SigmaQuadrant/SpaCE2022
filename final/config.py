...
parser.add_argument('--selector', type=str, default='chinese-deberta-large')
...
parser.add_argument('--generator', type=str, default='cpt')
parser.add_argument('--lr_gen', type=float, default=2.1e-5)
parser.add_argument('--bsz_gen', type=int, default=10)
...
test_dir = data_dir + jsonl_dir + '/task3_test.jsonl'

pretrained_model_dir = '../pretrained_model/'
selector_name, generator_name = args.selector, args.generator
selector_dir, generator_dir = pretrained_model_dir + selector_name, pretrained_model_dir + generator_name
